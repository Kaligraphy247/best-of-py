        ...
        <div className="self-center dark:text-white pl-4">
          ...
          <div className="py-1">
            <p className="line-clamp-1 text-[1rem] font-thin ">
              ...
              consectetur pariatur nam ad Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Doloremque aliquid laborum, dolor
            </p>
          </div>
          <div>
        ...
        <div className="space-y-2 text-[1rem]">
          <span className="border py-1 px-2  rounded-lg flex">
            <Link
              href={""}
              target="_blank"
              className="flex line-clamp-1 text-[0.9rem]"
            >
              <Image
                src="/github-mark.svg"
                alt="github-logo"
          ...
          <span className="border py-1 px-2 rounded-lg flex">
            <Link
              href={""}
              target="_blank"
              className="flex line-clamp-1 self-center text-[0.9rem]"
            >
              <FaHome size={18} />
          ...
          <span className="border py-1 px-2 rounded-lg flex">
            <Link
              ...
              className="flex line-clamp-1 text-[0.9rem]"
            >
              <Image src="/pypi.svg" alt="pypi-logo" width={20} height={16} />
